...
public class ResumoProdutoVendaAdapterActivity extends BaseAdapter {

    private Context context;
    private List<VendaProdutoView> produtosDaVenda;

    public ResumoProdutoVendaAdapterActivity(Context context, List<VendaProdutoView>produtosDaVenda) {
